  ...
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
            Chat with your 
        <span style={{ 
           background: 'linear-gradient(to right, #fd6eaa, #7a70ff)', 
      ...
      <div className="relative isolate">
        ...
        <div
            ...
            <div
              ...
              className='relative left-[calc(50%-25rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]'
            />
          </div>
        </div>
      </div>
